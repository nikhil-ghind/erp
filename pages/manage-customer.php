...
<?php
   ...
   if(isset($_SESSION['status'])){
      if($_SESSION['status']==CUSTOMER_DELETED_SUCCESS){
         $status="error";
         $msg=CUSTOMER_DELETED_SUCCESS;
      }
      else{
         if($_SESSION['status']==CUSTOMER_EDIT_SUCCESS){
            $status="success";
            $msg=CUSTOMER_EDIT_SUCCESS;
         }
      }
   }
...
<span class="required"> * </span>
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control" name="customer_address" id="customer_address" cols="30" rows="5" placeholder="Customer Address"></textarea>
                                 </div>
                            </div>
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="customer_contact" name="customer_contact" class="form-control" placeholder="Contact Number"/> </div>
                            </div>
                            <div class="form-group clearfix">
                                <label class="control-label col-md-3">GST NUMBER
                                 </label>
                                <div class="col-md-9">
                                    <input type="text" id="gst_no" name="gst_no" class="form-control" placeholder="GST Number"/> </div>
                            </div>
...
<![endif]-->
      ...
      <script>
         ...
         toastr["<?php echo $status;?>"]("<?php echo $msg;?>", "Customer Edit")
      </script>
         </body>
