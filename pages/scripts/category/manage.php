<?php
//THis is the php code for managing the tables in the manage-category page
...
while($row = mysqli_fetch_assoc($result)){
   ...
   $sub_array[] = "<button class='edit fa fa-pencil btn blue' id='".$row['category_id']."' data-toggle='modal' data-target='#editModal'> EDIT</button>";
   $sub_array[] = "<button class='delete fa fa-trash btn red' id='".$row["category_id"]."' data-toggle='modal' data-target='#deleteModal'> DELETE</button>";
