...
$columns = array("product.image_extension","product.product_name", "product.eoq","product_sale_rate.rate_of_sale", "product.additional_specification", "supplier_name", "category.category_name");
...
//      $image_path = "<img height='75px' class='img-responsive' src='http://localhost/erp/assets/products/images/".$image_name."'>";
//   }
//   else{
//      $image_path = '<img src="http://www.placehold.it/75x75/EFEFEF/AAAAAA&amp;text=no+image" alt="" />';
//   }
