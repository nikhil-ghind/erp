...
<span class="required"> * </span>
           ...
           <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" name="eoq" class="form-control" placeholder="EOQ LEVEL" value="0" />
                    </div>
                </div>
            </div>
        </div>
           ...
           <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label class="control-label col-md-2">Additional Description</label>
                    <div class="col-md-8">
                        <textarea name="additional_specification" id="additional_specification" cols="30" rows="3" class="form-control" placeholder="Add some description"></textarea> 
                   </div>
                </div>
            </div>
