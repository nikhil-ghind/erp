...
<?php
   ...
   if(isset($_SESSION['status'])){
      if($_SESSION['status']==CUSTOMER_ADDED_SUCCESS){
         $status="success";
         $msg=CUSTOMER_ADDED_SUCCESS;
      }
      else{
         if($_SESSION['status']==CUSTOMER_EXISTS_WARNING){
            $status = "warning";
            $msg=CUSTOMER_EXISTS_WARNING;
         }
      }
   }
                            ...
                            <div class="portlet-body">
                                ...
                                <form action="scripts/customer/add.php" id="add_customer_form" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Customer Addres
                                                </label>
                                            <div class="col-md-4">
                                               <textarea class="form-control" name="customer_address" id="" cols="30" rows="10" placeholder="Add customer's Address"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="customer_number" class="form-control" placeholder="Customer Number" /> </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="control-label col-md-3">GST Number
                                                    
                                                </label>
                                            <div class="col-md-4">
                                                <input type="text" name="gst_no" class="form-control" placeholder="GST Number" /> </div>
                                        </div>
                                    </div>
...
<![endif]-->
    ...
    <script>
       ...
       toastr["<?php echo $status;?>"]("<?php echo $msg;?>", "ADD CUSTOMER")
   </script>
</body>
